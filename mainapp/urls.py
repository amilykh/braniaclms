...
urlpatterns = [
    ...
    path('courses/',
         cache_page(3600)(views.CoursesListView.as_view()),
         name='courses'),
    path('courses/<int:pk>/detail/', views.CourseDetailView.as_view(),
         name='courses_detail'),
    # get-запрос без параметра
    path('courses/feedback/', views.CourseFeedbackCreateView.as_view(),
    ...
    path('news/<int:pk>/update/', views.NewsUpdateView.as_view(),
         name='news_update'),
    path('news/<int:pk>/detail/', views.NewsDetailView.as_view(),
         name='news_detail'),
